...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // 4. Form Action & Value Transfer Interceptor to /depositfunds
    plansGrid.addEventListener("click", (e) => {
        ...
        window.location.href = `/depositfunds?amount=${finalAllocation}&planId=${pId}&planName=${encodeURIComponent(foundPlan.name)}`;
    });
