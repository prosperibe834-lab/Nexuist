...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Call it immediately so it populates on page load
    ...
    form.addEventListener('submit', (e) => {
        ...
        // ... rest of your submit loader and hidden field logic remains the same
        ...
        // Update our hidden inputs with the actual text inside your custom dropdowns
        document.getElementById('hidden-country-field').value = document.getElementById('jur-active-name').textContent;
        document.getElementById('hidden-phone-code-field').value = document.getElementById('phone-active-code').textContent;

        // This line tells JavaScript to let the form submit naturally to your Laravel backend!
        form.submit();
    });
});