...
document.addEventListener('DOMContentLoaded', () => {
    // 1. Accordion Toggle for benefits
    const toggleBtn = document.getElementById('toggleBenefits');
    const content = document.getElementById('benefitsContent');

    toggleBtn.addEventListener('click', () => {
        // Toggle 'open' class for CSS max-height transition
        content.classList.toggle('open');
        toggleBtn.classList.toggle('active');
        
        // Dynamic Aria or Accessibility updates (Optional)
