...
// 4. Unified receipt handling (REMOVE the other one below to avoid conflicts)
function receiptNamed() {
    ...
    if (uploadInput.files.length > 0) {
        fileNameDisplay.innerText = uploadInput.files[0].name;
...
function openGateway(coin, network, addr, qr) {
    ...
    document.getElementById("selected-method-input").value = coin;
