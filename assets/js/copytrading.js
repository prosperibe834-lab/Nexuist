...
document.getElementById('refresh-btn').addEventListener('click', function() {
    ...
    // 2. Simulate a "Loading" state (like fetching data from an API)
    // In a real app, you'd put your data fetching code here
    setTimeout(() => {
        // Stop the animation after 1 second
        icon.classList.remove('spinning');
        
        // 3. Optional: Add a little toast or alert to show it worked
