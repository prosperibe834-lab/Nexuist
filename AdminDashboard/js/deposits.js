...
// =========================================================
    ...
    if (btnConfirmApprove) {
        btnConfirmApprove.addEventListener("click", () => {
            if (targetRowActiveScope) {
                targetRowActiveScope.setAttribute("data-status", "Approved");
                const visualBadge = targetRowActiveScope.querySelector(".nx-badge");
                if (visualBadge) {
                    visualBadge.className = "nx-badge status-approved";
    ...
    if (btnConfirmReject) {
        btnConfirmReject.addEventListener("click", () => {
            if (targetRowActiveScope) {
                targetRowActiveScope.setAttribute("data-status", "Rejected");
                const visualBadge = targetRowActiveScope.querySelector(".nx-badge");
                if (visualBadge) {
                    visualBadge.className = "nx-badge status-rejected";
